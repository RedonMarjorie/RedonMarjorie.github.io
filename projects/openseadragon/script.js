...
class Trigger extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement("a", {href: "https://hal.science/hal-02462678"}, "RBG panorama reconstruction: Clémentine Berthelot, Katia Zidane, Abderrahim El Moataz, Régis Clouard, Arnaud Daret, Antoine Verney et Cécile Binet. The reconstruction of the Bayeux tapestry panorama as a reference tool for a spatialised system of documentary information. Image-processing algorithms devoted to panorama construction and plotting of images on this panorama. OpenEdition Journals"),
      React.createElement("p", null,""),
